    ...
    <div class="">
        <div class="flex items-center min-h-screen p-6 w-full bg-gray-100">
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Ingresar
                    </a>
                @endauth
            </div>
        @endif --}}
                        ...
                        @foreach ($posts as $post)
                            <article class="rounded-xl bg-white w-full p-4 sm:p-6 lg:p-8 mb-10">
                                <div class="flex flex-col sm:gap-4 relative">
                                    <div class="">
                                        <img class="h-72 w-full rounded-md object-cover"
                                            src="/storage/images/{{ $post->photo }}" alt="">
                                    </div>
                                    <div class="">
                                        <strong
